				...
				<div className="row">
					<div className="col-md-6">
						<form onSubmit={(e)=>{handleSubmit(e)}}>
							...
							required />
							 <span style={{ color: "red" }}>{formdata.error.name}</span> <br/><br/>
							...
							<input 
							 ...
							 onChange={(e)=>{handleChange(e)}}
							 required  />
							  <span style={{ color: "red" }}>{formdata.error.email}</span> <br/><br/>

							<label for="exampleFormControlInput1" class="form-label">PhoneNo</label>
							<input 
							 type="number" 
							 ...
							 onChange={(e)=>{handleChange(e)}}
							 required  />
							  <span style={{ color: "red" }}>{formdata.error.mobileNumber}</span> <br/><br/>
							...
							<input 
							 ...
							 onChange={(e)=>{handleChange(e)}}
							 required  />
							  <span style={{ color: "red" }}>{formdata.error.pin}</span> <br/><br/>
